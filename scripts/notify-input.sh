#!/bin/bash
# TTS notification when Claude Code needs user input (tool approval, questions, etc.)
# Plays: "<session-id> claude code needs your input"
...
MSG="${SESSION_ID} claude code needs your input"
