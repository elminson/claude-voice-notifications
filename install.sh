...
cp "${SCRIPT_DIR}/scripts/notify-common.sh"   "$INSTALL_DIR/"
...
echo "Voice notifications are ON by default. Banners are ON by default."
echo ""
echo "Use /voice-notification inside Claude Code to configure:"
echo "  sounds, voices, volume, banners, quiet hours, escalation, and more."
echo ""
echo "Quick test (run inside Claude Code):"
echo "  /voice-notification test"
echo ""
